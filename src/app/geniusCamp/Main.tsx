...
export default function Main({ allCourse , role , id_u  }: prop) {
    ...
    return (
        <section className='grow-[2] bg-[#F1F1F1]'>
            <div className='w-full flex flex-wrap items-center justify-between mx-auto py-4 px-12 bg-white shadow-md'>
                <p className='text-5xl p-0 font-bold text-[#011F4B]'>ESC <span className='text-2xl'>ค่ายอัจฉริยะ</span></p>
